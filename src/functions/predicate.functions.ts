 ...
 */
export const isNumber = ((value) => typeof value === "number") as Predicate<number>;
 ...
 */
export const isBoolean = ((value) => typeof value === "boolean") as Predicate<boolean>;
 ...
 */
export const isArray = ((value) => isObject(value) && Array.isArray(value)) as Predicate<Array<unknown>>;
 ...
 */
export const isUndefined = ((value) => value === undefined) as Predicate<undefined>;
 ...
 */
export const isNullish = ((value) => isNull(value) || isUndefined(value)) as Predicate<null | undefined>;
